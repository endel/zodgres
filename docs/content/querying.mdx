---
title: Querying
description: Learn how to create, read, update, and delete records using SQL template literals
---

# Querying Collections

Zodgres provides a powerful and type-safe API for querying collections using SQL template literals. All operations return properly typed results based on your Zod schemas.
...
const contacts = await users.select`name, email FROM users`;
...
Zodgres provides a powerful, type-safe way to query your data:

- ✅ **Type Safety**: Full TypeScript support with schema validation
- ✅ **SQL Power**: Use familiar SQL with template literals
- ✅ **Parameter Safety**: Automatic SQL injection protection
- ✅ **Performance**: Efficient queries with proper indexing
- ✅ **Testing**: Easy testing with in-memory databases

The combination of Zod schemas and SQL template literals gives you both the safety of type checking and the power of SQL for complex queries.