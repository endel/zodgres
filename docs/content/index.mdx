...
<Cards>
  <Card title="Installation" href="/installation" description="Get started with zodgres installation" />
  <Card title="Collections" href="/collections" description="Create type-safe collections with Zod schemas" />
  <Card title="Querying" href="/querying" description="Query your data with SQL template literals" />
</Cards>
